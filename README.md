...
| Future repairs need rejected-state logs. | R061 adds `--trace_candidates` so R062+ runs can archive accepted and rejected VoI gate evaluations before any method claim. |
