...
One reproducibility wording issue was found and fixed during the audit:
`paper/sections/07_reproducibility_inventory.tex` previously described invalid
local `.git` metadata as the current version-provenance state. The project now
has a valid public Git repository, so the manuscript now says that the current
source state is tracked in GitHub while R048 preserves the earlier invalid-Git
source snapshot and command-provenance boundary.
...
| `paper/sections/04_results.tex` | `3E53C2CC7B5B014527B33CD88A1E9EFEC30E1B84893F03418FE71FC22614533D` |
...
| `results/EXPERIMENT_EVIDENCE_REGISTRY.csv` | `35D9BEFB48001EF27BEDCD90F9384ED31A56D9B012A1E737D305BA7E2BA3EFD2` |
