...
\begin{figure*}[t]
    ...
    \caption{Protocol-centered overview of the diagnostic evaluation route. The figure summarizes the HIL-RL trigger setting as a human-attention allocation problem, the cost-matched reversal, and the intervention trace diagnosis that motivates protocol discipline before further trigger redesign.}
