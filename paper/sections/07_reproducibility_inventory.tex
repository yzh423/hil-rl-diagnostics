...
Paper-claim audit & \texttt{paper/PAPER\_CLAIM\_AUDIT.md} and R052 & Current ledger checking manuscript numerical, comparison, and scope claims against the registry and primary sources. \\
\bottomrule
\end{tabular}
\end{table*}
