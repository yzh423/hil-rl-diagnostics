...
pre-registration gate. If an experiment is still needed, it should be a
narrowly pre-registered R063+ online repair with that logging and cost
matching.
...
| New phase/contact-aware online trigger | Only after R062 smoke passes and a pre-registered R063+ design exists | Could become a positive repair, but must log accepted/rejected candidate states and beat `random_b350`. |
