...
pass criteria, and escalation rule for future online repair experiments.
...
| Artifact | Purpose |
|---|---|
| `R062_PRE_REGISTRATION.md` | Claim map, anti-claims, formal-run gate, and escalation rule. |
...
| `EXPERIMENT_TRACKER.md` | Execution tracker separating R062 smoke validation from the later R063 decision and future R064+ online repairs. |
...
R063 later records no-go for formal online repair before the current
submission. A future R064+ online repair must be separately pre-registered if
that no-go is reversed, must archive accepted and rejected candidate-state
traces, and must be compared against the cost-matched random family before
manuscript claims can change.
